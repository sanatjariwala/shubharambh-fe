                        ...
                        <div className="col-md-6">
                            <div className="tpallblog mb-20 text-end">
                                <h4 className="blog-btn">
                                    <Link href="#">
                                        All News <i className="far fa-long-arrow-right" />
                                    </Link>
                                </h4>
                            </div>
                        </div>
                    ...
                    <div className="row gx-6">
                            ...
                            <div className="blogitem">
                                <div className="blogitem__thumb fix mb-20">
                                    <Link href="/blog-details">
                                        <img src="assets/img/blog/blog-thumb-01.jpg" alt="blog-bg" />
                                    </Link>
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 tpblogborder mb-30">
                            <div className="blogitem">
                                <div className="blogitem__thumb fix mb-20">
                                    <Link href="/blog-details">
                                        <img src="assets/img/blog/blog-thumb-02.jpg" alt="blog-bg" />
                                    </Link>
                                </div>
                                <div className="blogitem__content">
                                    <div className="blogitem__contetn-date mb-10">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 tpblogborder mb-30">
                            <div className="blogitem">
                                <div className="blogitem__thumb fix mb-20">
                                    <Link href="/blog-details">
                                        <img src="assets/img/blog/blog-thumb-03.jpg" alt="blog-bg" />
                                    </Link>
                                </div>
                                <div className="blogitem__content">
                                    <div className="blogitem__contetn-date mb-10">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
                            <div className="blogitem">
                                <div className="blogitem__thumb fix mb-20">
                                    <Link href="/blog-details">
                                        <img src="assets/img/blog/blog-thumb-04.jpg" alt="blog-bg" />
                                    </Link>
                                </div>
                                <div className="blogitem__content">
                                    <div className="blogitem__contetn-date mb-10">
