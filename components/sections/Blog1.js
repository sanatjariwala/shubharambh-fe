                                            ...
                                            <div className="tpallblog mb-20">
                                                <h4 className="blog-btn">
                                                    <Link href="/blog-details">
                                                        All Blog <i className="far fa-long-arrow-right" />
                                                    </Link>
                                                </h4>
                                            </div>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-sm-6">
                                        <div className="blogitem mb-40">
                                            <div className="blogitem__thumb fix mb-20">
                                                <Link href="/blog-details">
                                                    <img src="/assets/img/blog/blog-01.jpg" alt="blog-bg" />
                                                </Link>
                                            </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-6">
                                        <div className="blogitem mb-40">
                                            <div className="blogitem__thumb fix mb-20">
                                                <Link href="/blog-details">
                                                    <img src="/assets/img/blog/blog-02.jpg" alt="blog-bg" />
                                                </Link>
                                            </div>
                                            <div className="blogitem__content">
                                                <div className="blogitem__contetn-date mb-10">
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-6">
                                        <div className="blogitem mb-40">
                                            <div className="blogitem__thumb fix mb-20">
                                                <Link href="/blog-details">
                                                    <img src="/assets/img/blog/blog-03.jpg" alt="blog-bg" />
                                                </Link>
                                            </div>
                                            <div className="blogitem__content">
                                                <div className="blogitem__contetn-date mb-10">
                            ...
                            <div className="tpcta slider-bg text-center">
                                ...
                                <div className="tpcta__input p-relative mb-10">
                                    <form action="#">
                                        ...
                                        <span className="tpcta__input-icon">
