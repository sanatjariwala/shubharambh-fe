            ...
            <footer>
                <div className="footer-area theme-bg pt-65">
                    <div className="container">
                        <div className="main-footer pb-15 mb-30" style={{ border: "none" }}>
                            <div className="row">
                                    ...
                                    <div className="footer-widget footer-col-4 mb-40">
                                        ...
                                        <div className="footer-widget__links">
                                            <ul>
                                                ...
                                                <li><Link href="#"><i className="fab fa-whatsapp" />Whatsapp</Link></li>
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-7 col-md-5 col-sm-12">
                                    <div className="footer-copyright__content">
                                        <span>Copyright {new Date().getFullYear()} <Link href="/">©Shubharambh</Link>. All rights reserved. Developed by Sanat Jariwala.</span>
                                    </div>
                                </div>
