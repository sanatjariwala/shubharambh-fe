    ...
    return (
        <>
            <header>
                        ...
                        <div className="row align-items-center">
                            <div className="col-xl-7 col-lg-12 col-md-12">
                                <div className="header-welcome-text">
                                    ...
                                    <Link href="/shop" className="ms-3">Shop Now <i className="fal fa-long-arrow-right" /></Link>
                                </div>
                            </div>
                ...
                <div className="mainmenuarea d-none d-xl-block" style={{ borderBottom: "1px solid #f0f0f0", padding: "10px 0" }}>
                    <div className="container">
                        <div className="row align-items-center">
                            {/* Logo */}
